...
# coding: utf-8
#
# Python TCP Proxy 代理程序
#
# e.g:    A -> B -> C
#
#       B >> python tcpproxy.py B_ip B_port C_ip C_port [True|False]
#       A >> access C_ip C_port through B_ip B_port
#
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    while True:
        ...
        # if no more data on either side, close the connections y
